...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("srikr@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Sri@1008");
		...
		//used java streams in above line
		...
		li.sendKeys(country, "india").build().perform();
